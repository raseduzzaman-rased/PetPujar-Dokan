...
const Register = () => {
  return (
    <div className="bg-slate-200">
      <div className="max-w-11/12 mx-auto flex justify-center pb-12 pt-4">
        <div className="w-full max-w-md p-4 rounded-lg shadow-lg bg-white sm:p-8 dark:bg-gray-50 dark:text-gray-800">
          ...
          <p className="text-sm text-center dark:text-gray-600">
            ...
            <Link to="/login" className="focus:underline hover:underline">
              <span className="text-blue-500"> Signin here</span>
            </Link>
          </p>
